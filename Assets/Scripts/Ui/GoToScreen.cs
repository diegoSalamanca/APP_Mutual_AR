...
public class GoToScreen : MonoBehaviour
{
    ...
    public void GoToNewScreen()
    {
        ...
        iTween.MoveFrom(ScreenDestination, new Vector3(ScreenDestination.transform.position.x-200, ScreenDestination.transform.position.y, ScreenDestination.transform.position.z), 1f);
    }
}
